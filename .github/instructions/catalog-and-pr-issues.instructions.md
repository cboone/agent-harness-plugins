...
- Plugin manifests are the sole version source. Verify each changed plugin has a forward SemVer bump and that marketplace entries and metadata contain no `version` fields.
