...
A string with a stand-in segment is skipped, so `plugins/PLUGIN-NAME/README.md`, `plugins/<name>/README.md`, and `docs/plans/todo/YYYY-MM-DD-slug.md` need nothing. Two HTML comments cover the rest:
