...
| Installer            | Go  | Swift | Rust | Zig | Other |
| -------------------- | --- | ----- | ---- | --- | ----- |
| Homebrew             | Yes | Yes   | Yes  | Yes | No    |
| Shell install script | Yes | Yes   | Yes  | Yes | Yes   |
| go install           | Yes | No    | No   | No  | No    |
| cargo install        | No  | No    | Yes  | No  | No    |
