...
{
  "permissions": {
    "allow": ["Bash(git status*)", "Bash(git diff*)", "Bash(git log *)", "Bash(git add *)", "Bash(git commit *)", "Bash(git push*)", "Bash(git branch *)", "Bash(git fetch *)", "Bash(git merge-base *)", "Bash(git reflog show *)", "Bash(git ls-remote --heads *)", "Bash(git rev-parse *)", "Bash(git remote *)", "Bash(ssh -G *)", "Bash(sed *)", "Bash(git mv *)", "Bash(gh repo view *)", "Bash(gh issue view *)", "Bash(gh issue list *)", "Bash(gh pr create *)", "Bash(gh pr view *)", "Bash(gh pr list *)", "Bash(gh pr checks *)", "Bash(gh pr edit *)", "Bash(mktemp -u /tmp/gh-pr-body-*)", "Bash(rm -f /tmp/gh-pr-body-*)"]
  }
}
```
