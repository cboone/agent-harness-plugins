...
name: update-review
description: >-
  Find the latest branch review in docs/reviews/, assess commits made since
  that review, and update the review document in place with a unified
  reassessment. Use when the user says "update review", "update the review",
  "refresh the review", "re-review", "re-review the branch",
  "update branch review", "what's changed since the review", or any variant
  involving updating, refreshing, or continuing an existing branch review.
---
