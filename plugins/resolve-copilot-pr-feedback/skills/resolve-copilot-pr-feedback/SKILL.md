...
- **`hasFormatDrift`**: the complete drift signal. It is true when an old suppressed section or a non-clean `ccr-overview-v2` review contains no parseable findings.
