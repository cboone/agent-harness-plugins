...
{
  "permissions": {
    "allow": ["Bash(bash \"*/resolve-copilot-threads\" *)", "Bash(git push*)", "Bash(gh api repos/*/issues/*/comments*)", "Bash(mktemp -u /tmp/copilot-reply-*)", "Bash(rm -f /tmp/copilot-reply-*)", "Bash(gh pr comment *)", "Bash(mktemp -u /tmp/copilot-summary-*)", "Bash(rm -f /tmp/copilot-summary-*)"]
  }
}
```
