...
- `.dependencies` is left empty. Adding a dependency writes a multihash into this file, which gitleaks reads as a credential; `set-up-secret-scanning` covers the allowlist entry when that day comes.
