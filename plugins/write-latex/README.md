...
- Editing a `.tex` paper: activates automatically
- Configuring a LaTeX preamble or shared macros file: activates automatically
- Reviewing typesetting quality before submission: activates automatically
- "/write-latex": loads the full style guide explicitly

## See Also

- [Write Math](../write-math/README.md): mathematical exposition that often pairs with LaTeX typesetting
- [Write Pandoc Markdown](../write-pandoc-markdown/README.md): Pandoc Markdown sources that compile to LaTeX
