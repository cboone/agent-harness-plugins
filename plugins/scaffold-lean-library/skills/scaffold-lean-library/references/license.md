...
Use this exact template for `LICENSE`. Replace `YEAR` and `COPYRIGHT-HOLDER`.
...
- The generated repository uses Apache-2.0 to align with Lean and Mathlib formalization norms.
- Keep the full license text in `LICENSE`; use source headers for short copyright notices.
