...
When an incident does occur, it is important to report it promptly. To report a possible violation, contact **CONTACT-EMAIL**. All reports will be handled confidentially.
...
This template contains one placeholder:

| Placeholder     | Replace with                               |
| --------------- | ------------------------------------------ |
| `CONTACT-EMAIL` | Contact method for code of conduct reports |

The SKILL.md workflow offers three alternatives for the contact method:

- Email address (from `git config user.email` or user input)
