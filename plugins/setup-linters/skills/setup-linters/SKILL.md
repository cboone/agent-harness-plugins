...
description: >-
  ...
  "add formatting", "set up biome", "configure linters", "add code quality
...
For JavaScript/TypeScript, offer the choice between:

- **Classic**: ESLint + Prettier (mature ecosystem, rich plugin support)
- **Modern**: Biome (all-in-one linter + formatter, 10-100x faster, simpler config)
...
| ------------ | ------------------------------ | -------- |
| JavaScript   | ESLint + Prettier (or Biome)   | New      |
...
- Switch between ESLint + Prettier vs. Biome (for JS/TS projects)
