...
| Zsh           | shellcheck + shfmt + shellharden + checkbashisms | `brew install shellcheck shfmt shellharden devscripts`                                                                                                               | `.shellcheckrc`, `.editorconfig`, `scripts/check-zsh.zsh` | `check-zsh`, `format-zsh`    | `./languages/zsh.md`        |
