...
| Zsh           | 7-tool pipeline: zsh -n, zcompile, shellcheck, checkbashisms, shellharden, setopt warnings, shfmt | `brew install shellcheck shfmt shellharden devscripts`                                                                                                                                      | `.shellcheckrc`, `.editorconfig`                   | `check-zsh`, `format-zsh`    | `./languages/zsh.md`        |
