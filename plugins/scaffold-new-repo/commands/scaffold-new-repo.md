...
@${CLAUDE_PLUGIN_ROOT}/references/changelog.md

@${CLAUDE_PLUGIN_ROOT}/references/gitignore-templates.md

@${CLAUDE_PLUGIN_ROOT}/references/agents-md.md

@${CLAUDE_PLUGIN_ROOT}/references/copilot-instructions.md
