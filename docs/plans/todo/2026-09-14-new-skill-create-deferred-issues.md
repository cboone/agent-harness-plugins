...
- **Title**: imperative, under 70 characters, no trailing period. Always pass it single-quoted, since a backtick, `$(...)`, or `$NAME` inside a double-quoted shell argument is expanded; rephrase a title that needs an apostrophe.
