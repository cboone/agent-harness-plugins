...
1. **Checkout changes during review.** Modify a tracked file after requirements gathering but before the changed-file read. Confirm the tracked-cleanliness recheck stops the review before local content is used.
