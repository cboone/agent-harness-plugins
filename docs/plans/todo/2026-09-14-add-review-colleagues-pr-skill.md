...
- Immediately before any diff or commit-log read, fetch the base branch into its tracking ref again and compare its SHA with the recorded snapshot. If it changed, restart synchronization before reading review content.
