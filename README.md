...
Detect project languages and file types, recommend appropriate linters and formatters, install them, and generate config files. Supports JavaScript/TypeScript (ESLint + Prettier or Biome), Go, Python, Rust, Ruby, Shell, and cross-language tools (EditorConfig, markdownlint, Stylelint, Hadolint, Actionlint, and more).
