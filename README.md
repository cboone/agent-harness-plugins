...
- _Create Worktree:_ [`workmux`](https://github.com/paiml/workmux), plus [`gh`](https://cli.github.com/) when given an issue number and [`jq`](https://jqlang.org/) for an issue number or a resource claim
