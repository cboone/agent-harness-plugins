...
**Version files:** Individual plugin versions live in `plugins/<name>/.claude-plugin/plugin.json`. Marketplace entries are registration metadata and do not carry versions.
